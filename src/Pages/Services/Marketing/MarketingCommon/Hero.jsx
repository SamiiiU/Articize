...
const Hero = ({page}) => {
  ...
  return (
    <div className='w-full  relative overflow-hidden px-4 sm:px-16 md:px-28 2xl:px-80 
    sm:pt-40 pt-28 pb-28 flex justify-center  '>
        ...
        <div className='w-full flex justify-center flex-col lg:flex-row gap-10'>
            {/* Home text  */}
            <div className='lg:w-3/4 w-full lg:items-start md:items-center  z-20 flex flex-col gap-10 '>
                <h1 className=' font-[800] 2xl:text-[63px] text-5xl leading-none lg:text-left md:text-center text-left' dangerouslySetInnerHTML={{__html : page.heading}}></h1>
                <p className='text-[18px]'>{page.para}</p>

                <div className='md:rounded-lg flex md:flex-row flex-col z-20 sm:rounded-md gap-y-4 md:w-auto w-full overflow-hidden  text-lg md:text-xl'>
            ...
            {/* Home IMG  */}
            <div className='lg:w-1/2 w-full h-full  z-20'>
