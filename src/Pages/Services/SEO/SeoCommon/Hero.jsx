    ...
    style={{backgroundImage : `url(${BG})` , backgroundSize : 'cover' , backgroundPosition : 'center' }}>
        <div className='w-full flex justify-center flex-col lg:flex-row gap-10'>
            ...
            <div className='lg:w-3/4 w-full lg:items-start md:items-center  flex flex-col gap-10 '>
                <h1 className=' font-[800] lg:text-[63px] text-5xl leading-none lg:text-left md:text-center text-left'>{page.heroHeading}</h1>
                <p className='text-[18px]'>{page.heroText}</p>
            ...
            <div className='lg:w-1/2 w-full h-full  '>
                <div className='w-full h-[26rem] ' style={{backgroundImage : `url(${page.heroIMG})` , backgroundSize : 'contain' , backgroundPosition : 'center' , backgroundRepeat : 'no-repeat'}}/>
