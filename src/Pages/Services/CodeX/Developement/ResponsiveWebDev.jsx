...
import { responsiveWebDevData } from '../../../../Data/ServicesData/CodeXData/DevelopmentData'


const ResponsiveWebDev = () => {
  return (
    <div className='w-full'>
        <Nav/>
        <HeroCodeX page={responsiveWebDevData.heroSection}/>
        ...
        <UniquePackage page={responsiveWebDevData.customPackage}/>
        ...
        <ReviewsCodeX page={responsiveWebDevData.reviewSection} testimonals={CodeXTestimonalData.customDesign} />
...
export default ResponsiveWebDev