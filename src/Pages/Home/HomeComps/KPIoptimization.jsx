  ...
  return (
    <div className='w-full  px-4 sm:px-16 md:px-28 2xl:px-48 py-20 flex flex-col gap-10 text-center items-center '>
        ...
        <div className='w-full font-bold flex-wrap uppercase flex justify-center items-center sm:gap-x-12 gap-4 '>
            <span className={`px-4 py-6 rounded-lg ${selected ==1 ? 'text-[#207ce7] bg-[#EDF5FF]' : 'text-[#808b90]' }  cursor-pointer hover:bg-[#EDF5FF]`} onClick={() => handleKPI(1)}>Unlock</span>
            <span className={`px-4 py-6 rounded-lg ${selected ==2 ? 'text-[#207ce7] bg-[#EDF5FF]' : 'text-[#808b90]' }  cursor-pointer hover:bg-[#EDF5FF]`} onClick={() => handleKPI(2)}>Transform</span>
            <span className={`px-4 py-6 rounded-lg ${selected ==3 ? 'text-[#207ce7] bg-[#EDF5FF]' : 'text-[#808b90]' }  cursor-pointer hover:bg-[#EDF5FF]`} onClick={() => handleKPI(3)}>Secure</span>
            <span className={`px-4 py-6 rounded-lg ${selected ==4 ? 'text-[#207ce7] bg-[#EDF5FF]' : 'text-[#808b90]' }  cursor-pointer hover:bg-[#EDF5FF]`} onClick={() => handleKPI(4)}>Discover</span>
        </div>
