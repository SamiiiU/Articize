...
const SolutionChart = () => {
    ...
    return (
        <div className='w-full  px-4 sm:px-12 2xl:px-80 py-10 flex flex-col text-center '>
            ...
            <div className='w-full flex gap-20 justify-between  mt-9'>
                ...
                {HomeData.builtToScale.map((item, idx) => (
                    ...
                    style={{
                        ...
                        }} className={`py-6 px-8 text-2xl rounded-xl items-center transition-all flex gap-x-4 cursor-pointer ${idx == mouseOverIndex && 'hoverEffect'}`}>
                        <span>{item.icon}</span>
