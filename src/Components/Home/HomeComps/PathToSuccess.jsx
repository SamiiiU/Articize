...
const PathToSuccess = () => {
  return (
    <div className='w-full bg-[#00316A]/10 px-4 sm:px-16 md:px-28 2xl:px-48 py-20 flex flex-col gap-10 text-center items-center '>
        <h1 className='lg:text-[4rem] text-[2.5rem] font-[800]'>Path To <span className='text-[#207CE7]'>Digital Success</span></h1>
        ...
        <div className='w-full  h-auto relative gap-y-4 flex flex-col'>
            {/* path 1  */}
            <div className='flex relative flex-wrap lg:text-[1.4rem] text-[1rem] py-8  xl:items-center gap-y-4 justify-start border-[#2080EA] border-b-2'>
                {/* heading  */}
                <h1 className='xl:flex-1 w-full text-left xl:text-center lg:text-[1.75rem] text-[1.5rem] font-extrabold'>Drive Website Traffic</h1>

                <div className='xs:flex-1 w-full flex flex-col gap-y-4 font-medium  '>
                ...
                <span className='h-full w-1/2 absolute -left-1/2 bg-[#2080EA] rounded-tr-full'/>
            </div>

            {/* path 2   */}
            <div className='flex relative flex-wrap lg:text-[1.4rem] text-[1rem] py-8  xl:items-center gap-y-4 justify-start border-[#67EBC8] border-b-2'>
                {/* heading  */}
                <h1 className='xl:flex-1 w-full text-left xl:text-center lg:text-[1.75rem] text-[1.5rem] font-extrabold'>Create and manage powerful 
                ad campaigns</h1>
                ...
                <span className='h-full w-1/2 absolute -left-1/2 bg-[#67EBC8] rounded-tr-full'/>
            </div>

            {/* path 3   */}
            <div className='flex relative flex-wrap lg:text-[1.4rem] text-[1rem] py-8  xl:items-center gap-y-4 justify-start border-[#B9E688] border-b-2'>
                {/* heading  */}
                <h1 className='xl:flex-1 w-full text-left xl:text-center lg:text-[1.75rem] text-[1.5rem] font-extrabold'>Collect, analyze, and deploy marketing data</h1>
                ...
                <span className='h-full w-1/2 absolute -left-1/2 bg-[#B9E688] rounded-tr-full'/>
            </div>

            {/* path 4   */}
            <div className='flex relative flex-wrap lg:text-[1.4rem] text-[1rem] py-8  xl:items-center gap-y-4 justify-start border-[#FFE57F] border-b-2'>
                {/* heading  */}
                <h1 className='xl:flex-1 w-full text-left xl:text-center lg:text-[1.75rem] text-[1.5rem] font-extrabold'>Improve brand 
                ...
                <span className='h-full w-1/2 absolute -left-1/2 bg-[#FFE57F] rounded-tr-full'/>
            </div>
        </div>
    </div>
  )
